...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img src="images/icon/pet.png"  width="90" alt="petshop" />
                        </a>
                    </div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="has-sub">
                                <a href="#">
                                    ...
                                    <span class="bot-line"></span>Gerenciar</a>
                            ...
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                ...
                                <div class="account-dropdown js-dropdown">
                                    <div class="info clearfix">
                                        ...
                                        <div class="content">
                                            <h5 class="name">
                                                <a href="#"><?php echo $usuario_logado; ?></a>
                                            </h5>
                                            <span class="email"><?php echo $nivel_usuario; ?></span>
                                        </div>
                                    </div>
                                    <div class="account-dropdown__body">
                                        <div class="account-dropdown__item">
        ...
        <!-- MENU MOBILE  (não mexam aqui por enquanto)   -->
        ...
        <div class="sub-header-mobile-2 d-block d-lg-none">
            <div class="header__tool">
                ...
                <div class="account-wrap">
                    <div class="account-item account-item--style2 clearfix js-item-menu">
                        <div class="image">
                            <img src="images/icon/pet.png" alt="John Doe" />
                        </div>
                        <div class="content">
                            <a class="js-acc-btn" href="#">john doe</a>
                        </div>
